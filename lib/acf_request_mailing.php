...
if( function_exists('acf_add_local_field_group') ):
  ...
  acf_add_local_field_group(array(
    ...
    'fields' => array(
      ...
      array(
        'key' => 'field_5dce8233f51ac',
        'label' => 'Email to partner with confirmation of sending message',
        'name' => 'request_message_partner',
        'type' => 'group',
        'instructions' => $instructions_request . $instructions_message,
        'required' => 0,
        'conditional_logic' => 0,
