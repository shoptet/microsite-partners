...
acf_add_local_field_group(array (
	...
	'fields' => array (
		array (
			...
			'message' => 'Zobrazit odznak prověření',
			'default_value' => 0,
			'ui' => 0,
			'ui_on_text' => '',
			'ui_off_text' => '',
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			...
			'name' => 'description',
			'type' => 'textarea',
			'instructions' => 'Před text bude vložen nadpis H2 z nastavení typu příspěvku. Text bude použit v meta description. Pro více odstavců vložte prázdný řádek mezi odstavce.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
		...
		array (
			...
			'name' => 'benefit',
			'type' => 'wysiwyg',
			'instructions' => 'Před text bude vložen nadpis H2 z nastavení typu příspěvku.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
		...
		array (
			...
			'sub_fields' => array (
				...
				array (
					...
					'name' => 'text',
					'type' => 'textarea',
					'instructions' => 'Pro více odstavců vložte prázdný řádek mezi odstavce.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '',
